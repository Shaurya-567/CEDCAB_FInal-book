<nav class="navbar navbar-expand-lg navbar-light " id="mincls2">
  ...
  <div id="maindiv">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto admin_mrg">
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink" id="header_ullinks">
                  <li><a class="dropdown-item drop_item" href="./adminloaction.php">Location List</a></li>
                  <li><a class="dropdown-item drop_item" href="./addnewlocation.php">Add New Location</a></li>
        ...
        <div id="user_img">
          <img class="img-fluid" src="../<?php echo $_SESSION['admin']['file']; ?>">
        </div>
