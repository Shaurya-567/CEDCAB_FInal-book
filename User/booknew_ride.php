...
<head>
  ...
  <title><?php echo $_SESSION['user']['name'];?> Cab_cal</title>
</head>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header modal_head">
                <h5 class="modal-title modal_h5" id="exampleModalLongTitle">Customer Ride Details</h5>
  ...
  if(isset($_SESSION['ride']))
{
  ...
  <script>
    $(document).ready(()=>{
     ...
     type:"post",
     url:"../helper.php",
     data:{action:"modal_check"},
     success:function(result){
      //  console.log(result);
       let res=JSON.parse(result);
      //  console.log(res);
       $(".modal_fare").html("Pick Up Location: " + res.Pick_Up+ "<br> " + "Drop Location: " + res.Drop+ "<br>" + "Cab Type:" + res.Cab + "<br>" +
                "Your Luggage : " + res.Luggage + " Kg. <br>" + "Total Distance: " + res.Distance + " KM.<br> " + "Total Fare: " +
                res.Total_fare + " Rs.");
...
alert("Thank you For Fare Query ");
